...
private struct LayoutDebugModel {
    ...
    private static func sampleAction(action: String, amount: Int, ev: Double, evGap: Double) -> ActionEV {
        ActionEV(
            ...
            baseline_ev: ev,
            ev_stderr: 6,
            best_confidence: evGap == 0 ? "high" : "medium",
            is_clear_best: evGap == 0,
            is_best: evGap == 0,
            baseline_ev_stderr: 6,
            baseline_best_confidence: evGap == 0 ? "high" : "medium",
            baseline_is_clear_best: evGap == 0,
            baseline_is_best: evGap == 0,
            reason: "",
            why: WhyMetrics(
    ...
    func take(action: String) {
           ...
           let best = snapshot.max(by: { $0.ev < $1.ev })
        {
            ...
            pendingDecisionLogExtra = [
                ...
                "chosen_ev": chosen.ev,
                "chosen_baseline_ev": chosen.baseline_ev,
                "chosen_ev_stderr": chosen.ev_stderr,
                ...
                "best_ev": best.ev,
                "best_baseline_ev": best.baseline_ev,
                "best_ev_stderr": best.ev_stderr,
                ...
                "is_clear_best": best.is_clear_best,
                "regret": regret,
